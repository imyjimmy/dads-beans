                  ...
                  */}
                    {user ? (
                      <>
                        ...
                        <div>
                          {/* <a onClick={logOut} className="whitespace-nowrap cursor-pointer text-base font-medium text-gray-500 hover:text-gray-900">
                          Log out
                        </a> */}
                        </div>
                      </>
                      ...
                      <div>
                        ...
                        <a
                          href='/login'
                          className='flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-600 bg-opacity-80 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-opacity-70 hover:text-gray-900'
                        >
                          Sign in
                        </a>
                      </div>
